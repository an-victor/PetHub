...
import { getPetById, getVaccinesByPet, getUpcomingVaccines, getAppliedVaccines, getTreatmentsByPet } from '@/src/data';
...
const PetDetails: React.FC = () => {
    ...
    const vaccines = useMemo(() => getVaccinesByPet(id || ''), [id]);
    const upcomingVaccines = useMemo(() => getUpcomingVaccines(id || ''), [id]);
    const appliedVaccines = useMemo(() => getAppliedVaccines(id || ''), [id]);
