  ...
  return (
    <div className="flex flex-col pb-28 min-h-screen bg-background transition-colors duration-300">
      ...
      <div className="fixed bottom-28 z-50 transition-all duration-300 pointer-events-none w-full flex justify-center">
        <button className="pointer-events-auto flex size-14 items-center justify-center rounded-[20px] bg-gradient-to-br from-primary to-primary-dark text-white shadow-glow hover:shadow-glow-lg hover:scale-110 active:scale-95 transition-all duration-300 relative group">
