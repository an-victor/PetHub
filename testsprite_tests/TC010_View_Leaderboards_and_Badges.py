...
async def run_test():
    ...
    try:
        ...
        # Click on the leaderboard or gamification section button (Nível 3) to navigate to the Leaderboard screen.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Ultimate Champion Badge').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test case failed: The leaderboard rankings and earned badges are not displayed correctly as per the test plan.')
