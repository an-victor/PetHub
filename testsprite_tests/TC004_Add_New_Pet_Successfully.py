...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Meus Pets' section or 'Ver todos' to navigate to 'My Pets' screen.
        frame = context.pages[-1]
        # Click on 'Ver todos' link in 'Meus Pets' section to go to 'My Pets' screen.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Pet Addition Successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The new pet was not added successfully or did not appear immediately in the UI and local storage as required by the test plan.")
