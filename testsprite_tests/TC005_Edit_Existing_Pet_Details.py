...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Meus Pets' or 'Ver todos' to navigate to the 'My Pets' screen.
        frame = context.pages[-1]
        # Click 'Ver todos' link in 'Meus Pets' section to navigate to 'My Pets' screen
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Pet Update Successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The test plan execution failed to verify that the user can edit an existing pet's information and that changes persist correctly.")
